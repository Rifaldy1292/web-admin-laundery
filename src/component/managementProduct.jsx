...
import FromAddProduct from "../ui/fromAddProduct";
import FromEditProduct from "../ui/fromEditProduct.jsx";
import { getDataProduct, deleteProduct } from "../reqFrontEnd/request";
import DeleteConfirmation from "../ui/formDelete";
...
export default function ManagementProduct() {
  ...
  const fetchData = async () => {
    ...
    try {
      const respons = await getDataProduct(token);
  ...
  const handleDeleteConfirmation = async (productId) => {
    ...
    const respons = await deleteProduct(token, productId);
